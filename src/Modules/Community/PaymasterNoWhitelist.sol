...
/**
 * A paymaster variant that delegates target-address allowlisting to the off-chain sponsor.
 * Identical to Paymaster.sol but without the on-chain whitelist of allowed call targets:
 * the backend is expected to refuse to sign for disallowed targets.
 *
 ...
 */
contract PaymasterNoWhitelist is
    IPaymaster,
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    ...
    function initialize(address owner, address aSponsor) public virtual initializer {
